...
int main(int argc, char *argv[]) {
    ...
    ////////////////////////////
    // Access the message queue between calculator and mover
...
float calculateAvgCSV(char *filename , int file_number) {
    ...
    // Acquire the shared data semaphore
    ...
    #ifdef __CLI
    printf("\033[0;32mProcess:%d => CSV file: %s calculated successfully\033[0m\n",getpid(), filename);
    fflush(stdout);
    #endif
